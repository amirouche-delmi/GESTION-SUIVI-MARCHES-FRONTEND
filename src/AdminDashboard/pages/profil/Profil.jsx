...
import { dateParser, formaterNumeroTelephone, isEmpty, isValidEmail } from "../../../utils/utils";
        ...
        src="./imgs/admin.png"
          ...
          <span className="userShowTitle">Details du compte</span>
            ...
            <div className="userShowInfo">
              ...
              <span className="userShowInfoTitle">{userData.telephone ? formaterNumeroTelephone(userData.telephone) : ''}</span>
            </div>
            <div className="userShowInfo">
