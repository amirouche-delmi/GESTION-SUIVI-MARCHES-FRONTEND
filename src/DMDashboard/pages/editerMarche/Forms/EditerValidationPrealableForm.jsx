...
export default function AjouterValidationPrealableForm() {
  ...
  const handleRegister = async (e) => {
    ...
    if (marcheData.validationPrealableID) {
      try {
        ...
        toast.success("Validation Prealable mis à jour avec succès !", {
          duration: 6000,
          position: "bottom-right",
        });
      } catch (error) {
        console.error(error);
        toast.error("Une erreur s'est produite lors de la mise à jour de la Validation Prealable !", {
          duration: 6000,
          position: "bottom-right",
        });
      }
